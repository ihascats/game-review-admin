function ReviewInfoPageCard({
  ...
  return (
    <div className=" flex flex-col gap-6 sm:w-1/2 xl:w-1/3 2xl:w-1/4 self-center bg-gradient-to-br from-indigo-600 to-amber-600 text-slate-100 p-4 h-full">
      ...
      <div className=" flex w-full justify-between bg-zinc-800 px-3 py-6">
        ...
        <div className="grid">
          ...
          {isNaN(hltbInfo) ||
          isNaN(Number(steamInfo.final_formatted.substring(1))) ? (
